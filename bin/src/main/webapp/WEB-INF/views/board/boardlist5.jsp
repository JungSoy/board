		...
		$.ajax({
			...
			success : function(res) {
						...
						for (var i = 0; i < list.length; i++) {
							...
							data += "<tr>";
							data += "<td>" + list.bid + "</td>";
							data += "<td>" + list.cate + "</td>";
							data += "<td><a href='/board/boarddetail?bid=" + list.bid + "'>" + list.btitle + "</a></td>";
							data += "<td>" + formattedBregdate + "</td>";
							data += "<td>" + formattedBupdate + "</td>";
							data += "</tr>";
						}
