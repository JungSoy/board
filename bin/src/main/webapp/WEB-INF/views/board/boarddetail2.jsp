...
<%--          <input type="hidden" class="rid1" value="${r.rid1 }"> --%>
            <div class="panel panel-default">
        ...
        <div class="modal-dialog" role="documen bnt">
            <div class="modal-content">
                ...
                <div class="modal-body" id="modal-body">
                    <input type="hidden" id="rcontent1" name="rcontent1">
                </div>
...
//     }
	...
	//(댓글 수정)updateModel(${r.rid1}, ${r.rcontent1}) 에서 받은 값으로 modal을 띄우는 함수
...
//         form.attr("action", "/reply1/reply1delete");
