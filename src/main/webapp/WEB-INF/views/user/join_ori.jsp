        ...
        <form id="join_form" method="post" class="needs-validation" novalidate>
          <div class="row g-3">
            ...
            <div class="col-sm-6">
              ...
              <input type="text" class="form-control" id="uname" name="uname" placeholder="이름" required>
              <div class="invalid-feedback">
              </div>
            </div>

            <div class="col-12">
              <label for="uemail" class="form-label">Email <span class="text-body-secondary"></span></label>
            ...
            <div class="col-12">
              <label for="phone" class="form-label">전화번호<span class="text-body-secondary"></span></label>
              <input type="text" class="form-control" id="phone" name="phone" placeholder="010-0000-0000">
            </div>

          <hr class="my-4">

          <button class="w-100 btn btn-primary btn-lg" class="join_button" type="submit">회원가입</button>
        </form>
        </div>
</main>       
        <script>
